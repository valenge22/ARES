...
namespace AdministracionEmpleados
{
    public partial class MainForm : Form
    {
        ...
        private static string? PedirVersionAgent()
        {
            ...
            var version = new TextBox { Text = "1.7.2", Left = 22, Top = 45, Width = 350 };
            var publish = new Button { Text = "Publicar", Left = 272, Top = 84, Width = 100, DialogResult = DialogResult.OK };
            form.Controls.AddRange([new Label { Text = "Versión incluida en el ZIP (ejemplo: 1.7.2)", Left = 22, Top = 20, AutoSize = true }, version, publish]);
